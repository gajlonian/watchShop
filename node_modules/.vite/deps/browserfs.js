      ...
      return (
        ...
        function(modules) {
          ...
          function(module2, exports2, __webpack_require__) {
            (function(Buffer, global, module3, process) {
              "use strict";
              ...
              var ApiError = function(Error2) {
                ...
                ApiError2.prototype.writeToBuffer = function writeToBuffer(buffer$$1, i2) {
                  if (buffer$$1 === void 0)
                    buffer$$1 = Buffer.alloc(this.bufferSize());
                  if (i2 === void 0)
                    i2 = 0;
              ...
              Inode.prototype.toBuffer = function toBuffer(buff) {
                if (buff === void 0)
                  buff = Buffer.alloc(this.getSize());
                        ...
                        tx.put(oldParentINode.id, Buffer.from(JSON.stringify(oldParentList)), true, function(e) {
                          if (noErrorTx(e, tx, cb)) {
                            if (oldParent === newParent) {
                              ...
                              tx.put(newParentINode.id, Buffer.from(JSON.stringify(newParentList)), true, function(e2) {
                          ...
                          if (noErrorTx(e2, tx, cb)) {
                            ...
                            this$1.addNewNode(tx, fileInode.toBuffer(), function(e3, fileInodeId) {
                              if (noErrorTx(e3, tx, cb)) {
                                ...
                                tx.put(parentNode.id, Buffer.from(JSON.stringify(dirListing)), true, function(e4) {
                                  if (noErrorTx(e4, tx, cb)) {
                              ...
                              tx.del(fileNode.id, function(e3) {
                                if (noErrorTx(e3, tx, cb)) {
                                  tx.del(fileNodeId, function(e4) {
                                    if (noErrorTx(e4, tx, cb)) {
                                      tx.put(parentNode.id, Buffer.from(JSON.stringify(parentListing)), true, function(e5) {
                                        if (noErrorTx(e5, tx, cb)) {
                                          tx.commit(cb);
                                        }
                                      });
              ...
              FileDescriptorArgumentConverter.prototype.toRemoteArg = function toRemoteArg(fd, p, flag, cb) {
                ...
                fd.stat(function(err, stats) {
                  if (err) {
                    ...
                    if (flag.isReadable()) {
                      fd.read(Buffer.alloc(stats.size), 0, stats.size, 0, function(err2, bytesRead, buff) {
                        if (err2) {
                          cb(err2);
                        } else {
...
export default require_browserfs();
